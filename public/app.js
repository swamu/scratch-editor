...
;// CONCATENATED MODULE: ./src/components/global/Icon.js
...
;// CONCATENATED MODULE: ./src/components/global/Chip.js
...
const allOptionsData = [{
  ...
  Component: _ref4 => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.inputX,
      onChange: e => setSelectedValue('inputX', Number(e.target.value))
    }), "y: ", /*#__PURE__*/react.createElement("input", {
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.inputY,
      onChange: e => setSelectedValue('inputY', Number(e.target.value))
    }));
  }
}, {
  key: 'option-4',
  ...
  Component: _ref5 => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      className: "flex flex-row flex-wrap justify-center items-center  text-xs"
    }, "Point in", /*#__PURE__*/react.createElement("input", {
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.input,
      onChange: e => setSelectedValue('input', Number(e.target.value))
  ...
  Component: _ref6 => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      ...
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.inputSeconds,
      onChange: e => setSelectedValue('inputSeconds', Number(e.target.value))
    }), " seconds to x:", /*#__PURE__*/react.createElement("input", {
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.inputX,
      onChange: e => setSelectedValue('inputX', Number(e.target.value))
  ...
  Component: _ref7 => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      className: "flex flex-row flex-wrap justify-center items-center  text-xs"
    }, "Change x by", /*#__PURE__*/react.createElement("input", {
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.input,
      onChange: e => setSelectedValue('input', Number(e.target.value))
  ...
  Component: _ref8 => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      className: "flex flex-row flex-wrap justify-center items-center  text-xs"
    }, "Set x to", /*#__PURE__*/react.createElement("input", {
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.input,
      onChange: e => setSelectedValue('input', Number(e.target.value))
  ...
  Component: _ref9 => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      className: "flex flex-row flex-wrap justify-center items-center  text-xs"
    }, "Change y by", /*#__PURE__*/react.createElement("input", {
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.input,
      onChange: e => setSelectedValue('input', Number(e.target.value))
  ...
  Component: _ref10 => {
    ...
    return /*#__PURE__*/react.createElement("div", {
      className: "flex flex-row flex-wrap justify-center items-center  text-xs"
    }, "Set y to", /*#__PURE__*/react.createElement("input", {
      className: "rounded text-black w-10 mx-3 my-0.1 px-1",
      type: "number",
      value: selectedValue.input,
      onChange: e => setSelectedValue('input', Number(e.target.value))
...
const ItemProvider = _ref => {
  let {
    children
  } = _ref;
  const [transformProperties, setTransformProperties] = (0,react.useState)({
    position: {
      x: 0,
      y: 0
    },
...
;// CONCATENATED MODULE: ./src/components/ExecutionArea.js
...
function ExecutionArea() {
  ...
  const handleDrop = e => {
    ...
    const prevState = source === 0 ? {
      ...optionItems[originalPos]
    } : {
      ...currentStack[index]
    };
    const {
...
function PreviewArea() {
  ...
  (0,react.useEffect)(() => {
    const {
      current: previewAreaElement
    } = previewAreaRef;
    if (previewAreaElement) {
      const {
        height,
        width
      } = previewAreaElement.getBoundingClientRect();
...
function App() {
  return /*#__PURE__*/react.createElement(ItemProvider, null, /*#__PURE__*/react.createElement("div", {
    className: "bg-blue-100 text-xs font-sans overflow-y-hidden"
  ...
  }, /*#__PURE__*/react.createElement(Sidebar, null), /*#__PURE__*/react.createElement(ExecutionArea, null)), /*#__PURE__*/react.createElement("div", {
    className: "relative w-1/12 h-screen overflow-hidden flex flex-row bg-white border-t border-l border-gray-200 rounded-tl-xl ml-2"
  }, /*#__PURE__*/react.createElement(HistoryArea, null)), /*#__PURE__*/react.createElement("div", {
    className: "relative w-2/5 h-screen overflow-hidden flex flex-row bg-white border-t border-l border-gray-200 rounded-xl mx-2 p-2"
